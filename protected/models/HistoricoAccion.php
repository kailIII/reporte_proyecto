...
/**
 * This is the model class for table "historico_accion".
 *
 * The followings are the available columns in table 'historico_accion':
 ...
 */
class HistoricoAccion extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @return HistoricoAccion the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			array('codigo_accion, codigo_usuario, operacion, fecha', 'required'),
			array('codigo_accion, codigo_usuario, operacion', 'numerical', 'integerOnly'=>true),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('codigo, codigo_accion, codigo_usuario, operacion, fecha', 'safe', 'on'=>'search'),
		);
	}
