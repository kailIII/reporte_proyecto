...
class UsuarioController extends Controller
{
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Usuario']))
		{
			...
			if($model->validate(array('usuario','clave','nivel')))
			{
				$model->clave=md5($_POST['Usuario']['clave']);
				...
				if($model->save())
				{
					...
					$historico->usuario=$model->codigo;
	...
	public function actionUpdate($id)
	{
		...
		//Variable temporal para la clave
		$clave=$model->clave;
