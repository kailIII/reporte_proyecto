...
class PartidaController extends Controller
{
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Partida']))
		{
			...
			//Para validar la partida
			$validator=new CUniqueValidator;
			$validator->attributes=array('partida');
			$validator->allowEmpty=false;
			$validator->message='La partida {value} ya existe.';
			
			if($model->validate() && $validator->validate($model))
			{
				if($model->save())
				{
					$historico=new HistoricoPartida;
					$historico->codigo_partida=$model->codigo;
