...
class DefaultController extends Controller
{
	...
	public function actionIndex()
	{
		...
		if ($list_files )
		{
			...
			foreach ( $list as $id=>$filename )
			{
				...
				$columns['Longitud'] = floor(filesize ( $path. $filename)/ 1024) .' KB';
				$columns['Fecha'] = date( DATE_RFC822, filectime($path .$filename) );
				$dataArray[] = $columns;
			}
		}
	...
	protected function updateMenuItems($model = null)
	{
		...
		switch( $this->action->id)
		{
			case 'restore':
				{
					$this->menu[] = array('label'=>Yii::t('app', 'Ver Sitio') , 'url'=>Yii::app()->HomeUrl);
				}
			case 'create':
				{
					$this->menu[] = array('label'=>Yii::t('app', 'Lista de Respaldos'), 'url'=>array('index'));
				}
				break;
			case 'upload':
				{
					$this->menu[] = array('label'=>Yii::t('app', 'Crear Respaldo'), 'url'=>array('create'));
				}
				break;
			default:
				{
					$this->menu[] = array('label'=>Yii::t('app', 'Lista de Respaldos'), 'url'=>array('index'));
					$this->menu[] = array('label'=>Yii::t('app', 'Crear Respaldo'), 'url'=>array('create'));
					$this->menu[] = array('label'=>Yii::t('app', 'Subir Respaldo'), 'url'=>array('upload'));
					$this->menu[] = array('label'=>Yii::t('app', 'Restaurar Respaldo') , 'url'=>array('restore'));
					//$this->menu[] = array('label'=>Yii::t('app', 'Limpiar Base de Datos'), 'url'=>array('clean'));
					//$this->menu[] = array('label'=>Yii::t('app', 'Ver Sitio') , 'url'=>Yii::app()->HomeUrl);
				}
				break;
		}
